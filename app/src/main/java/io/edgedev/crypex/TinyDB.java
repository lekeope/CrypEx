...
*/
    ...
    public ArrayList<Currency> getListCurrency(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Currency> objects =  new ArrayList<>();

    	for(String jObjString : objStrings){
    		Currency value  = gson.fromJson(jObjString,  Currency.class);
    		objects.add(value);
    	}
    	return objects;
    }
...
//
    ...
    public void putListCurrency(String key, List<Currency> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<>();
    	for(Object obj : objArray){
